...
public class ChunkDataLoader extends CacheLoader<ChunkPos, CompletableFuture<CachedChunkData>> {
    ...
    public CompletableFuture<CachedChunkData> load(ChunkPos pos) {
        ...
        try {
            ...
            CompletableFuture<CachedChunkData> future = CompletableFuture.allOf(heightsFuture, wateroffsFuture, treeCoverFuture, osmRegionsFuture)
                    .thenApply(unused -> {
                        ...
                        Set<OSMPolygon> polygons = Collections.emptySet();
